...
class VirtualAgentWrapper(object): # pylint: disable=too-few-public-methods
    """
    Wrapper around the IVirtualAgent object that adds some (hopefully) useful
    utility methods
    ...
    def registerDerivedEventHandler(self, oSubClass, dArgs = None):
        """
        Create an instance of the given VirtualAgentEventHandlerBase sub-class
        and register it.
        ...
        return oSubClass.registerDerivedEventHandler(self.oVBoxMgr, self.fpApiVer, oSubClass, dArgsCopy,
                                                     self.o, 'IVirtualAgent', 'IVirtualAgentCallback');
...
class SessionWrapper(TdTaskBase):
        ...
        if self.fpApiVer >= 7.0:
            ...
            try:
                ...
                if fEnable:
                    ...
                    self.o.machine.nonVolatileStore.uefiVariableStore.enrollCINASEEKPlatformKey();
    ...
    def detachHd(self, sController = "IDE Controller", iPort = 0, iDevice = 0):
        ...
        try:
            ...
            if    self.oVBoxMgr.xcptIsOurXcptKind() \
              and self.oVBoxMgr.xcptIsEqual(None, self.oVBoxMgr.constants.VRA_E_OBJECT_NOT_FOUND):
    ...
    def getPrimaryIp(self):
        ...
        """
        sIpAddr = self.getGuestPropertyValue('/VirtualAgent/GuestInfo/Net/0/V4/IP');
...
class TxsConnectTask(TdTaskBase):
    ...
    class TxsConnectTaskVBoxCallback(vbox.VirtualAgentEventHandlerBase):
        """ Class for looking for IPv4 address changes on interface 0."""
        def __init__(self, dArgs):
            vbox.VirtualAgentEventHandlerBase.__init__(self, dArgs);
        ...
        def onGuestPropertyChange(self, sMachineId, sName, sValue, sFlags, fWasDeleted):
            ...
            if    sMachineId == self.sMachineId \
              and sName  == '/VirtualAgent/GuestInfo/Net/0/V4/IP':
    ...
    def __init__(self, oSession, cMsTimeout, sIpAddr, sMacAddr, oIDhcpServer, fReversedSetup, fnProcessEvents = None):
        ...
        if fReversedSetup is True:
            ...
            #try:
            #    oSession.delGuestPropertyValue('/VirtualAgent/GuestInfo/Net/0/V4/IP');
            #except:
            #    reporter.logXcpt();
            ...
            try:
                sIpAddr = oSession.getGuestPropertyValue('/VirtualAgent/GuestInfo/Net/0/V4/IP');
            except:
                reporter.errorXcpt('IMachine::getGuestPropertyValue("/VirtualAgent/GuestInfo/Net/0/V4/IP") failed');
