...
class tdGuestHostTimings(vbox.TestDriver):                                         # pylint: disable=too-many-instance-attributes
    ...
    def actionExecuteOnRunnigVM(self):
        ...
        oMachine = oVirtualAgent.findMachine(self.sVMname)
        ...
        oSession = self.oVBoxMgr.mgr.getSessionObject(oVirtualAgent)
    ...
    def seekLatestAudioFileName(self, guestSession, duration):
        ...
        # Assuming that .wav files are named like 2016-11-15T12_08_27.669573100Z.wav by VRA audio backend
