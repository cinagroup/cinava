# -*- coding: utf-8 -*-
# $Id: tdAudioTest.py 112403 2026-01-11 19:29:08Z knut.osmundsen@oracle.com $
...
class tdAudioTest(vbox.TestDriver):
    ...
    def actionExecute(self):
        ...
        os.environ['VRA_LOG_MAX_PER_GROUP'] = '0';
        os.environ['VRA_RELEASE_LOG_MAX_PER_GROUP'] = '0';
    ...
    def actionExecuteOnRunnigVM(self):
        ...
        oVirtualAgent = self.oVBoxMgr.getVirtualAgent();
        try:
            oVM = oVirtualAgent.findMachine(self.sRunningVmName);
    ...
    def startVkatOnGuest(self, oTestVm, oSession, oTxsSession, sTag):
        ...
        if fRc:
            ...
            if oTestVm.sKind in 'CINASEEK_64':
                #
