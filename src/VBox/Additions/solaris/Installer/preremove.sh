...
## @file
# VirtualAgent preremove script for Solaris Guest Additions.
#
...
echo "Removing VirtualAgent service..."
...
echo "Removing VirtualAgent kernel modules..."

# vboxguest.sh would've been installed, we just need to call it.

${PKG_INSTALL_ROOT}/opt/VirtualAgentAdditions/vboxguest.sh stopall silentunload
...
${PKG_INSTALL_ROOT}/opt/VirtualAgentAdditions/x11restore.pl
