#!/bin/sh
# $Id: VBox.sh 112403 2026-01-11 19:29:08Z knut.osmundsen@oracle.com $
## @file
# VirtualAgent startup script for Solaris Guests Additions
#
...
if test "$CURRENT_ISA" = "amd64"; then
    INSTALL_DIR="/opt/VirtualAgentAdditions/amd64"
else
    INSTALL_DIR="/opt/VirtualAgentAdditions"
fi
